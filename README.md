...
Use **Run guided demo** in the same console for the live operator readiness, synthetic accounts and six-step member-to-manager presentation sequence. The companion [demonstration walkthrough](docs/DEMO_WALKTHROUGH.md) records the spoken script and the product boundaries to state clearly.
